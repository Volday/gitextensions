...
namespace GitUI.HelperDialogs
{
    ...
    /// </summary>
    public partial class FormMergeRemoteProcess : FormMergeProcess
    {
        #region Translation
...
Do you want to register the host's fingerprint and restart the process?");
        ...
        private protected FormMergeRemoteProcess()
            : base()
        {
            InitializeComponent();
        }

        public FormMergeRemoteProcess([NotNull] GitUICommands commands, string process, ArgumentString arguments)
        ...
        {
            using (var formRemoteProcess = new FormMergeRemoteProcess(commands, process: null, arguments))
            {
